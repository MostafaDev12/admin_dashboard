    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="<?php echo e(route('admin-partners-index')); ?>" aria-controls="sidebarpartners">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown" id="general">
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo e(route('admin-gs-logo')); ?>" class="nav-link" data-key="t-Logo"> <?php echo app('translator')->get('translation.logo'); ?>
                                    </a>
                                </li>
