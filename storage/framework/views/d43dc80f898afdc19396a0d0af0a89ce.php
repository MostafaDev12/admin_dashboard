                                ...
                                <div class="card-body">
                                    <table id="geniustable" class="table nowrap dt-responsive align-middle table-hover table-bordered" style="width:100%">
                                        <thead>
                                          ...
                                          <th width="50%"><?php echo e(__('الصلاحيات')); ?></th>
...
<?php $__env->startSection('script'); ?>
    ...
    var table = $('#geniustable').DataTable({
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
          '<a class="add-btn  btn btn-sm btn-secondary" href="<?php echo e(route('admin-role-create')); ?>">'+
          '<i class="fas fa-plus"></i> <?php echo e(__("اضافه صلاحيه ")); ?>'+
          '</a>'+
          '</div>');
      });
