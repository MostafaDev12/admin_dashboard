                                    ...
                                    <div class="tab-content  text-muted">
                                        <div class="tab-pane active" id="base-justified-home" role="tabpanel">
                                            <h6 style="text-align: center;">   <?php echo e(__('translation.arabic')); ?></h6>
                                              ...
                                              <div class="mb-3">
                                                  ...
                                                  <textarea class="form-control" name="about_details_ar"  id="details_ar" rows="3" placeholder="<?php echo e(__('translation.details')); ?>"><?php echo e($ps->about_details_ar); ?></textarea>
                                              </div>
                                        ...
                                        <div class="tab-pane " id="base-justified-product" role="tabpanel">
                                          ...
                                          <div class="mb-3">
                                              ...
                                              <textarea class="form-control" name="about_details_en"  id="details_en" rows="3" placeholder="<?php echo e(__('translation.details')); ?>"><?php echo e($ps->about_details_en); ?></textarea>
                                          </div>
                                        ...
                                        <div class="tab-pane" id="base-justified-messages" role="tabpanel">
                                          ...
                                          <div class="mb-3">
                                              ...
                                              <textarea class="form-control" name="about_details_fr"  id="details_fr" rows="3" placeholder="<?php echo e(__('translation.details')); ?>"><?php echo e($ps->about_details_fr); ?></textarea>
                                          </div>
                                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\cangrow-admin\resources\views/admin/pagesetting/about_us.blade.php ENDPATH**/ ?>